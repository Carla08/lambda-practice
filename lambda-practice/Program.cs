    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var ctx = new DatabaseContext())
            {
                ...
                Console.WriteLine("\nEmpleados trabajados en remoto:\n");
                ...
                Console.WriteLine("\nEmpleados cuyo aniversario de contratación es el siguiente mes\n");
                ...
                var employeesEachMonth = from Employee in ctx.Employees
                ...
                foreach (var employee in employeesEachMonth)
                {
